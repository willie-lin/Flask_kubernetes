...
# -*- coding:utf-8 _*-  
""" 
# @Time    : 2019/3/27 19:01 
# @Author  :  林皆醉 
# @Desc : =============================================
# @FileName: list_ingress_for_all_namespaces.py
# @Software: PyCharm
...
def list_ingress_for_all_namespaces():
    ...
    resource_version = 'extensions/v1beta1' # str | When specified with a watch call, shows changes that occur after that particular version of a resource. Defaults to changes from the beginning of history. When specified for list: - if unset, then the result is returned from remote storage based on quorum-read flag; - if it's 0, then we simply return what we currently have in cache, no guarantee; - if set to non zero, then the result is at least as fresh as given rv. (optional)
    timeout_seconds = 5  # int | Timeout for the list/watch call. This limits the duration of the call, regardless of any activity or inactivity. (optional)
    ...
    try:
        ...
        api_response = extensions_v1beta1.list_ingress_for_all_namespaces(_continue='null', timeout_seconds=timeout_seconds, label_selector='null',  watch=watch)
        print(api_response)
